            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="prose prose-lg text-gray-700 space-y-4">
                  ...
                  <p>
                    Following her clerkship, Amber returned to practice with Larry Downing. When he retired in 2010, she and Steven Dittrich—colleagues since 2001—formalized their partnership, now in its 15th year. As both a practicing attorney and the mother of two active children who has personally experienced divorce, Amber brings unique insight to understanding the legal complexities and emotional challenges her clients face during family transitions.
                  </p>
                  <p>
